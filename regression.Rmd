...
Adding an interation term takes the form of changing the traditional form (show above) to:

\begin{align}
y & = \beta_0 + \beta_1X_1 + \beta_2X_2 + \beta_3X_1X_2 \\
& = \beta_0 + \beta_1X_1 + \beta_3X_1X_2 + \beta_2X_2 \\
& = \beta_0 + X_1(\beta_1 + \beta_3X_2) + \beta_2X_2 \\
& = \beta_0 + \tilde{\beta_1}X_1 + \beta_2X_2~~where~~\tilde{\beta_1} = \beta_1 + \beta_3X_2
\end{align}

Thus, $\beta_3$ can be interpreted as the change in the **effectiveness of $X_1$ on y for a one unit change in $X_2$.**
