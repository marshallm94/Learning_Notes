...
- _What is the iDRAC?_
  - The Integrated Dell Remote Access Controller (iDRAC) remote system access
- _What is the LCC?_
  - Lifecycle Controller - 
- _How to install an OS?_
- _What is the UEFI Boot Manager?_
  - Unified Extensible Firmware Interface (UEFI) is a modern replacement for the BIOS (Basic Input/Output System) that connects a computers OS to its
    firmware.
- PCI = Peripheral Component Interconnect
- PCIe = Peripheral Component Interconnect Express

1. Flash bootable USB drive with Ubuntu OSI file
2. configure RAID
3. idk honestly
Had to do raid
